# Матриця трасування (Test Matrix) [cite: 101]

Цей документ демонструє відповідність між розробленими Use Cases та інженерними автоматизованими тестами у файлі `UnitTest1.cs`. [cite: 101]
